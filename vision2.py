...
IMAGE1_BLACK_PATH = "black1.png"
IMAGE2_BLACK_PATH = "black2.png"
IMAGE1_WHITE_PATH = "test1.jpg"
IMAGE2_WHITE_PATH = "test2.jpg"
IMAGE3_WHITE_PATH = "test3.jpg"
IMAGE4_WHITE_PATH = "test4.png"
BLACK_BASE_PATH = "blackBase.jpg"
WHITE_BASE_PATH = "base1.jpg"
...
def chooseBasePath(point, img) :

    x, y = point
    path = WHITE_BASE_PATH
    
    gray =  cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
    if(gray[x][y] < (255 / 2)) :
        path = BLACK_BASE_PATH
...
if __name__ == '__main__':
    ...
    # Read source images
    img1 = cv2.imread(IMAGE3_WHITE_PATH)
    img2 = cv2.imread(IMAGE4_WHITE_PATH)
    
    
    # Convert to array 8 bit images
    img1 = np.uint8(img1)
    img2 = np.uint8(img2)
    ...
    points1_list = toListTuples(points1)
    # Find convex hull
    hullIndex1 = cv2.convexHull(np.array(points1_list), returnPoints = False)
    ...
    # Choose path for whites or blacks
    path = chooseBasePath(center1, img1)
    
    # Read base image
    imgBase = cv2.imread(path)
